(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-sources-sources-module"], {
    ...
    /***/
    function g1y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SourcesRoutingModule", function () {
      ...
      var _components_sources_view_sources_view_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./components/sources-view/sources-view.component */
      "GqF8");
      ...
      var SourcesRoutingModule = function SourcesRoutingModule() {
        _classCallCheck(this, SourcesRoutingModule);
      };

      SourcesRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function FdNB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SourcesModule", function () {
      ...
      var _sources_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./sources-routing.module */
      "9g1y");
      /* harmony import */


      var _components_sources_view_sources_view_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./components/sources-view/sources-view.component */
      "GqF8");
      /* harmony import */
      ...
      var SourcesModule = function SourcesModule() {
        _classCallCheck(this, SourcesModule);
      };

      SourcesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_components_sources_view_sources_view_component__WEBPACK_IMPORTED_MODULE_4__["SourcesViewComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _sources_routing_module__WEBPACK_IMPORTED_MODULE_3__["SourcesRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_6__["MatRippleModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_7__["NgxPaginationModule"], angular_highcharts__WEBPACK_IMPORTED_MODULE_9__["ChartModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_10__["SharedModule"]]
      })], SourcesModule);
      /***/
    },
    ...
    /***/
    function GqF8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SourcesViewComponent", function () {
        return SourcesViewComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_sources_view_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./sources-view.component.html */
      "VSfA");
      /* harmony import */


      var _sources_view_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./sources-view.component.scss */
      "NPSH");
      /* harmony import */
      ...
      var _services_sources_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _subscription_services_subscription_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./../../../subscription/services/subscription.service */
      "qCmP");

      var SourcesViewComponent = /*#__PURE__*/function () {
        function SourcesViewComponent(service, subscriptionService, modalService, toastr, formBuilder, spinner) {
          _classCallCheck(this, SourcesViewComponent);
        ...
        _createClass(SourcesViewComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this = this;

            this.getActiveSubsciption();
            Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["of"])(this.getTypes()).subscribe(function (orders) {
              _this.Types = orders;
            });
            this.initForm();
          }
          ...
          value: function getActiveSubsciption() {
            ...
            this.spinner.show();
            this.subscriptionService.getActiveSubsciption().subscribe(function (response) {
              _this2.subsciption = response;

              if (_this2.subsciption) {
                _this2.getAssignedSources();
              }
          ...
          value: function markFormGroupTouched(formGroup) {
            ...
            Object.values(formGroup.controls).forEach(function (control) {
              ...
              if (control.controls) {
                _this3.markFormGroupTouched(control);
              }
            });
            return true;
          }
        }, {
          key: "getUnassignedSources",
          value: function getUnassignedSources() {
            var _this4 = this;

            this.spinner.show();
            this.service.getUnassignedSources().subscribe(function (response) {
              _this4.UnassignedSources = response;
          ...
          key: "getAssignedSources",
          value: function getAssignedSources() {
            var _this5 = this;

            this.spinner.show();
            this.service.getAssignedSources().subscribe(function (response) {
              _this5.AssignedSources = response;

              _this5.getUnassignedSources();

              _this5.spinner.hide();
            }, function (err) {
              //handle errors here
              _this5.toastr.error(err.error.Message);
            });
          }
        }, {
          key: "AddSourceRequest",
          value: function AddSourceRequest() {
            var _this6 = this;

            this.spinner.show();
            this.service.AddSourceRequest(this.forms.value).subscribe(function (response) {
              _this6.getUnassignedSources();

              _this6.getAssignedSources();

              _this6.spinner.hide();

              _this6.toastr.success("Request added");

              _this6.initForm();
            }, function (err) {
              //handle errors here
              _this6.toastr.error(err.error.Message);
            });
          }
        }, {
          key: "openModal",
          value: function openModal(ref) {
            this.modal = this.modalService.open(ref, {
              size: 'lg',
              centered: true
            });
          }
          ...
          value: function AssignSource() {
            ...
            if (source) {
              data = this.UnassignedSources.filter(function (state) {
          ...
          value: function UnassignSource() {
            ...
            if (source) {
              data = this.AssignedSources.filter(function (state) {
                return state.Id != source.Id;
              });
            } else {
              data = selected;
            ...
            this.service.AssignSource({
              ...
              //handle errors here
              _this8.toastr.error(err.error.Message);
            });
          }
        }, {
          key: "AssignedAllSelection",
          value: function AssignedAllSelection() {
            var _this9 = this;

            this.ShowAssignedAll = 0;
            this.UnassignedSources.filter(function (res) {
              res.select === true ? _this9.ShowAssignedAll++ : '';
            });
          }
        }, {
          key: "AssignedAll",
          value: function AssignedAll() {
            var data = [];
            this.UnassignedSources.filter(function (res) {
          ...
          key: "UnassignedAllSelection",
          value: function UnassignedAllSelection() {
            var _this10 = this;

            this.ShowUnassignedAll = 0;
            this.AssignedSources.filter(function (res) {
              res.select === true ? _this10.ShowUnassignedAll++ : '';
            });
          }
        }, {
          key: "UnassignedAll",
          value: function UnassignedAll() {
            var data = [];
            this.AssignedSources.filter(function (res) {
              res.select === true ? '' : data.push(res.Id);
            });
      ...
      SourcesViewComponent.ctorParameters = function () {
        return [{
      ...
      SourcesViewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function NPSH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function RCT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SourcesService", function () {
      ...
      var SourcesService = /*#__PURE__*/function () {
        ...
        _createClass(SourcesService, [{
          ...
          key: "AddSourceRequest",
          value: function AddSourceRequest(data) {
            return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].AddSourceRequest, data);
          }
        }, {
          key: "AssignSource",
          value: function AssignSource(data) {
            return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].CustomSources, {
              params: data
            });
          }
        }]);
      ...
      SourcesService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }];
      };

      SourcesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], SourcesService);
      /***/
    },
    ...
    /***/
    function VSfA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=components-sources-sources-module-es5.js.map